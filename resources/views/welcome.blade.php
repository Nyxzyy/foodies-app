                                    ...
                                    <div class="overlay-content">
                                        ...
                                        @if (Route::has('login'))
                                            ...
                                            <form method="POST" action="http://127.0.0.1:8000/logout" x-data>
                                                @csrf
                                                {{-- <input type="hidden" name="_token" value="hM9LIILUbNUBCGXeDRY9Q4HCGZcEtkB1xxleunPa"> --}}
                                                <a href="http://127.0.0.1:8000/logout"
                                                    class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" @click.prevent = "$root.submit();">Logout</a>
                                            </form>
                                            @else
                                                <a href="{{ route('login') }}"
